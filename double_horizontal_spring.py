...
def integrate(xvo, ti, p):
	x1, v1, x2, v2 = xvo
	m1, k1, xeq1, m2, k2, xeq2 = p

	return [v1, a1.subs({M1:m1, K1:k1, K2:k2, XEQ1:xeq1, XEQ2:xeq2, X1:x1, X2:x2}),\
		v2, a2.subs({M2:m2, K2:k2, XEQ2:xeq2, X1:x1, X2:x2})]
...
def run(frame):
	...
	plt.title("A Double Horizontal Spring")
	ax=plt.gca()
	ax.set_aspect(1)
	plt.xlim([xmin,xmax])
	plt.ylim([ymin,ymax])
...
ani.save('double_horizontal_spring.mp4', writer=writervideo)
plt.show()
